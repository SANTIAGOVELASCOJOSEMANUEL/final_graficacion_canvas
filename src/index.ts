...
const canvas: HTMLCanvasElement = document.getElementById('circlechart') as HTMLCanvasElement;
...
let starTrail: { x: number; y: number }[] = [];
...
const palabraInput = document.getElementById('palabra') as HTMLInputElement;
...
const tamañoInput = document.getElementById('tamaño') as HTMLInputElement;
